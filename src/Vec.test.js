import {
    matComponentWiseProduct, matCompSum, matScaleByVec,
    vecAdd,
    vecAdd2,
    vecComponentWiseProduct,
    vecCompSum,
    vecDistance,
    vecNormalize, vecRound,
    vecScale
} from "./Vec";
...
test('matScaleByVec', () => {
    const m = [[1, 2, 3], [0, 0, 0], [3, 2, 1]];
    const v = [-1, 0, 1];
    expect(matScaleByVec(m, v)).toStrictEqual([[-1, -2, -3], [0, 0, 0], [3, 2, 1]])
});

test('matCompSum', () => {
    const m = [[1, 2, 3], [0, 0, 0], [3, 2, 5]];
